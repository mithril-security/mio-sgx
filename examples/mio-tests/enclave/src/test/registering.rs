...
#[cfg(debug_assertions)]
use crate::test::util::assert_error;
use crate::test::util::{any_local_address, init};
...
pub fn tcp_register_multiple_event_loops() {
    init();
...
//#[test]
#[cfg(debug_assertions)] // Check is only present when debug assertions are enabled.
pub fn udp_register_multiple_event_loops() {
    init();
...
//#[test]
pub fn registering_after_deregistering() {
    init();
