...
//#[test]
pub fn multiple_writes_immediate_success() {
    init();
...
//#[test]
pub fn connection_reset_by_peer() {
    init();
...
//#[test]
pub fn tcp_no_events_after_deregister() {
