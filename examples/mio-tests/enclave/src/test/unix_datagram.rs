...
//#[test]
pub fn unix_datagram_smoke_unconnected() {
    init();
...
//#[test]
pub fn unix_datagram_smoke_connected() {
    init();
...
//#[test]
pub fn unix_datagram_smoke_unconnected_from_std() {
    init();
...
//#[test]
pub fn unix_datagram_smoke_connected_from_std() {
    init();
...
//#[test]
pub fn unix_datagram_reregister() {
    let (mut poll, mut events) = init_with_poll();
...
//#[test]
pub fn unix_datagram_deregister() {
    let (mut poll, mut events) = init_with_poll();
