...
//#[test]
pub fn unconnected_udp_socket_ipv4() {
...
//#[test]
pub fn unconnected_udp_socket_std() {
...
//#[test]
pub fn get_ttl_without_previous_set() {
    let socket1 = UdpSocket::bind(any_local_address()).unwrap();
...
//#[test]
pub fn get_broadcast_without_previous_set() {
    let socket1 = UdpSocket::bind(any_local_address()).unwrap();
...
//#[test]
pub fn set_get_multicast_loop_v4() {
    let socket1 = UdpSocket::bind(any_local_address()).unwrap();
...
//#[test]
pub fn get_multicast_loop_v4_without_previous_set() {
    let socket1 = UdpSocket::bind(any_local_address()).unwrap();
...
//#[test]
pub fn set_get_multicast_ttl_v4() {
    let socket1 = UdpSocket::bind(any_local_address()).unwrap();
...
//#[test]
pub fn get_multicast_ttl_v4_without_previous_set() {
    let socket1 = UdpSocket::bind(any_local_address()).unwrap();
...
//#[test]
pub fn connected_udp_socket_ipv4() {
    let socket1 = UdpSocket::bind(any_local_address()).unwrap();
    let address1 = socket1.local_addr().unwrap();
...
//#[test]
pub fn connected_udp_socket_std() {
    let socket1 = net::UdpSocket::bind(any_local_address()).unwrap();
    let address1 = socket1.local_addr().unwrap();
...
//#[test]
pub fn reconnect_udp_socket_sending() {
    let (mut poll, mut events) = init_with_poll();
...
//#[test]
pub fn reconnect_udp_socket_receiving() {
    let (mut poll, mut events) = init_with_poll();
...
//#[test]
pub fn unconnected_udp_socket_connected_methods() {
    let (mut poll, mut events) = init_with_poll();
...
//#[test]
pub fn connected_udp_socket_unconnected_methods() {
    let (mut poll, mut events) = init_with_poll();
    ...
    // socket is connected.
    #[cfg(not(any(target_os = "android", target_os = "linux", target_os = "windows", target_env = "sgx")))]
...
//#[test]
pub fn udp_socket_no_events_after_deregister() {
    let (mut poll, mut events) = init_with_poll();
